...
import {Ownable} from "../coffeecore/Ownable.sol";
...
{
    // Define 'owner'
    // Ownable.sol has a method owner() that clashes with this var
    ...
    // Can be used to return states as strings, with index from enum
    // states[item[_upc].itemState]
    string[8] states = [
        "Harvested",
        "Processed",
        "Packed",
    ...
    // Define a modifer that checks to see if msg.sender == owner of the ITEM
    modifier onlyOwnerOfItem(uint256 _upc) {
