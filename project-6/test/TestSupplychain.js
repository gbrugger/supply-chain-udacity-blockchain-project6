// This script is designed to test the solidity smart contract - SuppyChain.sol --
...
contract("SupplyChain", (accounts) => {
  ...
  it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
    ...
    assert.equal(
      resultBufferTwo[2],
      Number(upc) + Number(resultBufferOne[0]),
  ...
  it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async () => {
    ...
    assert.equal(
      resultBufferOne[2],
      consumerID, // Last one in the process
      "Error: Missing or Invalid ownerID"
    );
    assert.equal(
      resultBufferOne[3],
  ...
  it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async () => {
    ...
    const prodId = Number(upc) + Number(resultBufferTwo[0]);
    assert.equal(resultBufferTwo[2], prodId, "Error: Invalid ProductID");
